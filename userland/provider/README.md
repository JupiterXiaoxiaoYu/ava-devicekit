...
- Do not hardcode one vendor into app logic; choose chain, AI, market, and execution providers through runtime config.
...
Use `provider.catalog.example.json` for selectable ASR/LLM/TTS and execution config examples, including custom Python provider classes.
