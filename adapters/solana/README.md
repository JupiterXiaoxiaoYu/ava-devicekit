...
The adapter does not import or depend on previous assistant runtime modules. Trading, watchlist, portfolio, and skill behavior belong to the Ava Box app layer, not this basic chain adapter.
